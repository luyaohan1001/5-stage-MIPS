...
VL_INLINE_OPT void Valu___024root___ico_sequent__TOP__0(Valu___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.alu__DOT__BB = ((8U & (IData)(vlSelfRef.Func))
                               ? (~ vlSelfRef.In2) : vlSelfRef.In2);
    vlSelfRef.alu__DOT__S = (vlSelfRef.In1 + (vlSelfRef.alu__DOT__BB 
                                              + (1U 
...
VL_INLINE_OPT void Valu___024root___nba_sequent__TOP__0(Valu___024root* vlSelf) {
    ...
    if ((4U & (IData)(vlSelfRef.Func))) {
        if ((2U & (IData)(vlSelfRef.Func))) {
            if ((1U & (IData)(vlSelfRef.Func))) {
                vlSelfRef.ALUout = (vlSelfRef.alu__DOT__S 
                                    >> 0x1fU);
            }
        } else {
            vlSelfRef.ALUout = ((1U & (IData)(vlSelfRef.Func))
                                 ? vlSelfRef.In2 : 
                                (~ (vlSelfRef.In1 ^ vlSelfRef.alu__DOT__BB)));
        }
    } else {
        vlSelfRef.ALUout = ((2U & (IData)(vlSelfRef.Func))
                             ? ((1U & (IData)(vlSelfRef.Func))
                                 ? (vlSelfRef.In1 ^ vlSelfRef.alu__DOT__BB)
                                 : vlSelfRef.alu__DOT__S)
                             : ((1U & (IData)(vlSelfRef.Func))
                                 ? (vlSelfRef.In1 | vlSelfRef.alu__DOT__BB)
                                 : (vlSelfRef.In1 & vlSelfRef.alu__DOT__BB)));
    }
...
#endif
            VL_FATAL_MT("alu.v", 71, "", "Input combinational region did not converge.");
        }
...
#endif
            VL_FATAL_MT("alu.v", 71, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("alu.v", 71, "", "Active region did not converge.");
            }
...
void Valu___024root___eval_debug_assertions(Valu___024root* vlSelf) {
    ...
    if (VL_UNLIKELY(((vlSelfRef.Func & 0xf0U)))) {
